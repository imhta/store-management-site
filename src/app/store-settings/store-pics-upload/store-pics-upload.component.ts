...
@Component({
  ...
  templateUrl: './store-pics-upload.component.html',
  styleUrls: ['./store-pics-upload.component.scss']
})
export class StorePicsUploadComponent implements OnInit, OnDestroy {
